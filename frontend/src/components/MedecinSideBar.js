                ...
                <ul className="nav nav-pills flex-column mb-auto" style={{ width: '100%' }}>
                    ...
                    <li className="nav-item mb-3">
                        <NavLink
                            ...
                            activeClassName="active"
                        >
                            <FontAwesomeIcon icon={faUser} className="me-2" /> Consultations
                        </NavLink>
                    </li>
                    <li className="nav-item mb-3">
                        <NavLink
                            to="/reports" // Replace with your actual route for reports
                            className="nav-link link-light fw-bolder"
                            activeClassName="active"
                        >
                            <FontAwesomeIcon icon={faFile} className="me-2" /> Rapports
                        </NavLink>
                    </li>
                    <hr />
                </ul>
